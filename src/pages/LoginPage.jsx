...
export default function LoginPage() {
  ...
  const handleSubmit = (role) => {
    ...
    setTimeout(() => {
      setLoading(null)
      alert(`Signed in as ${role} to Student Assistant absence & leave tracking system!`)
      navigate('/')
    }, 1000)
  }
  ...
  return (
    <div className="w-screen min-h-screen bg-[#1A6FBF] flex flex-col overflow-y-auto overflow-x-hidden font-sans">
      {/* HEADER - 52px height, 100% width */}
      <header className="w-full h-[52px] min-h-[52px] bg-white flex items-center justify-between px-6 lg:px-8 border-b border-[#E5E7EB] shrink-0">
      ...
      {/* MAIN - 1200px max-width, 100vw outer, scrollable */}
      <main className="flex-1 w-full max-w-[1200px] mx-auto px-6 lg:px-8 py-8 lg:py-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <div className="lg:col-span-6 flex flex-col gap-6">
          <div>
            ...
            <p className="text-[12px] text-[#475569]/80 mt-2 leading-relaxed max-w-[400px]">
              Sign in to your Student Assistant absence & leave tracking system account to manage absences, approvals, and schedules.
            </p>
          </div>

          <div className="bg-[#F8FAFC] rounded-[8px] border border-[#E2E8F0] p-6 shadow-sm max-w-[480px] w-full">
            <div className="flex flex-col gap-4">
              <div>
                ...
                <div className="relative mt-1.5">
                  ...
                  <input type="email" value={form.email} onChange={(e)=>setForm({...form, email:e.target.value})} placeholder="e.g. name@university.edu" className="w-full h-[36px] pl-9 pr-3 rounded-[6px] border border-[#E2E8F0] bg-white text-[11px] placeholder:text-[#94A3B8] focus:outline-none focus:border-[#3B82F6]" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative mt-1.5">
                  ...
                  <input type={showPass ? 'text' : 'password'} value={form.password} onChange={(e)=>setForm({...form, password:e.target.value})} placeholder="••••••••" className="w-full h-[36px] pl-9 pr-9 rounded-[6px] border border-[#E2E8F0] bg-white text-[11px] focus:outline-none focus:border-[#3B82F6]" />
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" checked={form.keepSigned} onChange={(e)=>setForm({...form, keepSigned:e.target.checked})} className="w-3.5 h-3.5 rounded border-[#CBD5E1] text-[#3B82F6]" />
          ...
          <div className="bg-[#93C5FD]/40 backdrop-blur rounded-[10px] border border-[#60A5FA]/30 p-3.5 flex gap-3 max-w-[480px] w-full">
            ...
            <div>
              ...
              <p className="text-[10px] text-[#475569]/80 mt-0.5 leading-snug">The Student Assistant absence & leave tracking system portal will be undergoing scheduled updates this Sunday from 2:00 AM to 4:00 AM EST.</p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-6 relative flex flex-col items-center lg:items-end gap-6">
          <div className="hidden lg:flex bg-white rounded-[14px] shadow-lg border border-[#E2E8F0] p-3 items-center gap-2.5 self-end mr-8">
            ...
            <div><p className="text-[11px] font-bold text-[#0F172A] leading-none">Verified</p><p className="text-[8px] text-[#64748B] mt-0.5">Attendance Logged</p></div>
          </div>
          ...
          <div className="relative w-full max-w-[420px]">
            ...
            <div className="relative bg-[#F59E0B] rounded-[14px] overflow-hidden shadow-xl border border-[#FBBF24]/30">
              <img src={notebookImg} alt="Student Assistant absence & leave tracking system - 2025 planner" className="w-full h-[260px] object-cover" />
            </div>
            <div className="absolute -left-6 -bottom-8 bg-[#FFFBEB] rounded-[12px] shadow-lg border border-[#FDE68A] p-3.5 w-[200px]">
              <div className="flex justify-between items-center"><p className="text-[10px] font-semibold text-[#0F172A]">Weekly Progress</p><span className="text-[10px] font-bold text-[#1E5BDA]">92%</span></div>
              <div className="mt-2 h-1.5 bg-[#FEF3C7] rounded-full overflow-hidden"><div className="h-full w-[92%] bg-[#FBBF24] rounded-full"></div></div>
      ...
      <footer className="w-full bg-[#1860A8] border-t border-[#1E6CB6] mt-8">
        <div className="w-full max-w-[1200px] mx-auto px-6 lg:px-8 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div><p className="text-[13px] font-bold text-[#0F172A]">Contact Us</p><div className="mt-4 space-y-2.5 text-[10px] text-[#1E3A5F]/70"><div className="flex gap-2"><span>10 OR tambo Witbank, Emalahleni, 1034, South Africa.</span></div><div className="flex gap-2"><span>+27 (0)86 110 2421</span></div><div className="flex gap-2"><a href="mailto:general@tut.ac.z" className="underline text-[#93C5FD]">general@tut.ac.z</a></div></div></div>
          <div><p className="text-[13px] font-bold text-[#0F172A]">Platform</p><ul className="mt-4 space-y-2 text-[10px] text-[#1E3A5F]/60"><li>Features</li><li>Documentation</li><li>Support Center</li><li>Status</li></ul></div>
          <div><p className="text-[13px] font-bold text-[#0F172A]">Legal</p><ul className="mt-4 space-y-2 text-[10px] text-[#1E3A5F]/60"><li>Privacy Policy</li><li>Terms of Service</li><li>Security</li><li>Administration</li></ul></div>
          <div><p className="text-[13px] font-bold text-[#0F172A]">Connect</p><p className="text-[9px] text-[#1E3A5F]/50 mt-4 leading-snug max-w-[200px]">Ensuring seamless academic scheduling and management for Student Assistant absence & leave tracking system.</p></div>
        </div>
        <div className="w-full max-w-[1200px] mx-auto px-6 lg:px-8 py-4 border-t border-[#1E5A9A] flex flex-col md:flex-row justify-between items-center gap-2 text-[10px] text-[#1E3A5F]/50">
          <span>© 2026 Student Assistant absence & leave tracking system. All rights reserved.</span>
          <div className="flex gap-4"><span>Accessibility</span><span>Contact Support</span></div>
        </div>
      </footer>
    </div>
  )
